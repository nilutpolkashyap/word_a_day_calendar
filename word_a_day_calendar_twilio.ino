...
const char * messagingServiceSid = "TWILIO_SERVICE_ID";
const char * to = "RECEIVER_PHONE_NUMBER";
const char * accountNr = "TWILIO_ACCOUNT_NUMBER";
const char * twilioPassword = "TWILIO_PASSWORD";
...
//    M5.Lcd.print("\"");
  ...
  if(SMS_SEND == 0)
  {
    String NEW_WORD = "Word of the day: " + word1 + word_def;
